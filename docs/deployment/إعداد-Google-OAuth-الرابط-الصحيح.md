# ✅ إعداد Google OAuth - الرابط الصحيح
...
```json
{
  "frontendUrl": "https://alnuimie515.vercel.app",
  "frontendUrlProcessed": "https://alnuimie515.vercel.app",
  "redirectUri": "https://alnuimie515.vercel.app/auth/google/callback",
  "exactRedirectUri": "https://alnuimie515.vercel.app/auth/google/callback",
  "hasClientId": true,
...
- **Application home page**: `https://alnuimie515.vercel.app`
...
1. افتح [https://alnuimie515.vercel.app](https://alnuimie515.vercel.app)
...
- [ ] أضفت `https://alnuimie515.vercel.app/auth/google/callback` في Google Cloud Console → Authorized redirect URIs
- [ ] أضفت `https://alnuimie515.vercel.app` في Google Cloud Console → Authorized JavaScript origins
- [ ] حدثت `FRONTEND_URL` في Render إلى `https://alnuimie515.vercel.app`
...
- **Frontend (Vercel)**: [https://alnuimie515.vercel.app](https://alnuimie515.vercel.app)
- **Backend (Render)**: [https://construction-backend-nw0g.onrender.com](https://construction-backend-nw0g.onrender.com)
- **Debug Endpoint**: [https://construction-backend-nw0g.onrender.com/api/auth/google/debug](https://construction-backend-nw0g.onrender.com/api/auth/google/debug)
